...
async fn main() -> anyhow::Result<()> {
    ...
    let labels = vec![
        ("daikichi-new", "大吉", "今日の運勢は大吉！最高の一日があなたを待ってる！"),
        ("kichi-new", "吉", "今日の運勢は吉！楽しい一日になりそう！"),
        ("chukichi-new", "中吉", "今日の運勢は中吉！楽しんでいこ！"),
        ("shokichi-new", "小吉", "今日の運勢は小吉！小さな幸せ見つけよう！"),
        ("suekichi-new", "末吉", "今日の運勢は末吉！すえひろがりな一日を！"),
        ("kyo-new", "凶", "今日の運勢は凶。気を引き締めていこう！"),
        ("daikyo-new", "大凶", "今日の運勢は大凶。無理せず慎重に！"),
    ];
